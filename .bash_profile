...
alias glu='g lu | cat && echo'    # pretty log (commits not pushed to develop)
alias glum='g lu | cat && echo'   # pretty log (commits not pushed to master)
alias glua='g lu | cat && echo'   # pretty log (all unpushed commits)
